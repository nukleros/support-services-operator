...
// sampleExternalDNS is a sample containing all fields
const sampleExternalDNS = `apiVersion: gateway.support-services.nukleros.io/v1alpha1
kind: ExternalDNS
metadata:
...
// sampleExternalDNSRequired is a sample containing only required fields
const sampleExternalDNSRequired = `apiVersion: gateway.support-services.nukleros.io/v1alpha1
kind: ExternalDNS
metadata:
  name: externaldns-sample
spec:
...
func GenerateForCLI(workloadFile []byte, collectionFile []byte) ([]client.Object, error) {
	var workloadObj gatewayv1alpha1.ExternalDNS
...
var CreateFuncs = []func(
	...
	*workload.Request,
	...
	CreateServiceAccountNamespaceServiceAccountName,
...
func ConvertWorkload(component, collection workload.Workload) (
	...
	*orchestrationv1alpha1.SupportServices,
	...
	p, ok := component.(*gatewayv1alpha1.ExternalDNS)
	if !ok {
		return nil, nil, gatewayv1alpha1.ErrUnableToConvertExternalDNS
	}

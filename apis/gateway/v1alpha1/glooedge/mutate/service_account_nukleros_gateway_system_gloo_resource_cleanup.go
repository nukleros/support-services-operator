...
// MutateServiceAccountNuklerosGatewaySystemGlooResourceCleanup mutates the ServiceAccount resource with name gloo-resource-cleanup.
func MutateServiceAccountNuklerosGatewaySystemGlooResourceCleanup(

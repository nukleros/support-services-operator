...
// MutateClusterRoleGlooGraphqlapiMutatorDefault mutates the ClusterRole resource with name gloo-graphqlapi-mutator-default.
func MutateClusterRoleGlooGraphqlapiMutatorDefault(

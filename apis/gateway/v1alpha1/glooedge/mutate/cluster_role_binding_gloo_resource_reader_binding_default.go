...
// MutateClusterRoleBindingGlooResourceReaderBindingDefault mutates the ClusterRoleBinding resource with name gloo-resource-reader-binding-default.
func MutateClusterRoleBindingGlooResourceReaderBindingDefault(

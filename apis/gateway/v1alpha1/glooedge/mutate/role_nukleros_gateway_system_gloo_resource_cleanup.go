...
// MutateRoleNuklerosGatewaySystemGlooResourceCleanup mutates the Role resource with name gloo-resource-cleanup.
func MutateRoleNuklerosGatewaySystemGlooResourceCleanup(

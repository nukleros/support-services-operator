...
// MutateClusterRoleGlooResourceRolloutDefault mutates the ClusterRole resource with name gloo-resource-rollout-default.
func MutateClusterRoleGlooResourceRolloutDefault(

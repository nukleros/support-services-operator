...
// MutateClusterRoleKubeResourceWatcherDefault mutates the ClusterRole resource with name kube-resource-watcher-default.
func MutateClusterRoleKubeResourceWatcherDefault(

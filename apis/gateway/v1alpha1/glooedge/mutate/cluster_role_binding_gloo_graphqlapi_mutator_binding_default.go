...
// MutateClusterRoleBindingGlooGraphqlapiMutatorBindingDefault mutates the ClusterRoleBinding resource with name gloo-graphqlapi-mutator-binding-default.
func MutateClusterRoleBindingGlooGraphqlapiMutatorBindingDefault(

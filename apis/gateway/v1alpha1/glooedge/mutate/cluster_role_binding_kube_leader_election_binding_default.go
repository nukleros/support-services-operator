...
// MutateClusterRoleBindingKubeLeaderElectionBindingDefault mutates the ClusterRoleBinding resource with name kube-leader-election-binding-default.
func MutateClusterRoleBindingKubeLeaderElectionBindingDefault(

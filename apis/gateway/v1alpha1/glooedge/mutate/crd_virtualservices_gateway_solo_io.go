...
// MutateCRDVirtualservicesGatewaySoloIo mutates the CustomResourceDefinition resource with name virtualservices.gateway.solo.io.
func MutateCRDVirtualservicesGatewaySoloIo(

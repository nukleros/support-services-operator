...
// MutateValidatingWebhookGlooGatewayValidationWebhookDefault mutates the ValidatingWebhookConfiguration resource with name gloo-gateway-validation-webhook-default.
func MutateValidatingWebhookGlooGatewayValidationWebhookDefault(

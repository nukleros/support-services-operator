...
// MutateClusterRoleBindingGlooResourceCleanupDefault mutates the ClusterRoleBinding resource with name gloo-resource-cleanup-default.
func MutateClusterRoleBindingGlooResourceCleanupDefault(

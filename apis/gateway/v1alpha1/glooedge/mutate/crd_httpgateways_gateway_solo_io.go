...
// MutateCRDHttpgatewaysGatewaySoloIo mutates the CustomResourceDefinition resource with name httpgateways.gateway.solo.io.
func MutateCRDHttpgatewaysGatewaySoloIo(

...
// MutateCRDRouteoptionsGatewaySoloIo mutates the CustomResourceDefinition resource with name routeoptions.gateway.solo.io.
func MutateCRDRouteoptionsGatewaySoloIo(

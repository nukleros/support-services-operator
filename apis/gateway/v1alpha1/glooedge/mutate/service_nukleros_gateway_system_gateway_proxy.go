...
// MutateServiceNuklerosGatewaySystemGatewayProxy mutates the Service resource with name gateway-proxy.
func MutateServiceNuklerosGatewaySystemGatewayProxy(

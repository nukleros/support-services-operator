...
// MutateClusterRoleBindingSettingsUserBindingDefault mutates the ClusterRoleBinding resource with name settings-user-binding-default.
func MutateClusterRoleBindingSettingsUserBindingDefault(

...
// MutateDeploymentNuklerosGatewaySystemGatewayProxy mutates the Deployment resource with name gateway-proxy.
func MutateDeploymentNuklerosGatewaySystemGatewayProxy(

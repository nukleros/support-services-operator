...
// MutateClusterRoleGlooResourceMutatorDefault mutates the ClusterRole resource with name gloo-resource-mutator-default.
func MutateClusterRoleGlooResourceMutatorDefault(

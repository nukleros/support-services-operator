...
// MutateConfigMapNamespaceGatewayProxyEnvoyConfig mutates the ConfigMap resource with name gateway-proxy-envoy-config.
func MutateConfigMapNamespaceGatewayProxyEnvoyConfig(

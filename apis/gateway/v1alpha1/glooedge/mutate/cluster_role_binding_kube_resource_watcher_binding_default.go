...
// MutateClusterRoleBindingKubeResourceWatcherBindingDefault mutates the ClusterRoleBinding resource with name kube-resource-watcher-binding-default.
func MutateClusterRoleBindingKubeResourceWatcherBindingDefault(

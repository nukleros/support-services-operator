...
// MutateClusterRoleKubeLeaderElectionDefault mutates the ClusterRole resource with name kube-leader-election-default.
func MutateClusterRoleKubeLeaderElectionDefault(

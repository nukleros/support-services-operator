...
// MutateClusterRoleGlooGatewaySecretCreateDefault mutates the ClusterRole resource with name gloo-gateway-secret-create-default.
func MutateClusterRoleGlooGatewaySecretCreateDefault(

...
// MutateCRDVirtualhostoptionsGatewaySoloIo mutates the CustomResourceDefinition resource with name virtualhostoptions.gateway.solo.io.
func MutateCRDVirtualhostoptionsGatewaySoloIo(

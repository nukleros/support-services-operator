...
// MutateClusterRoleGlooResourceReaderDefault mutates the ClusterRole resource with name gloo-resource-reader-default.
func MutateClusterRoleGlooResourceReaderDefault(

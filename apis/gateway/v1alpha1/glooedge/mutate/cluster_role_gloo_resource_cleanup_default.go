...
// MutateClusterRoleGlooResourceCleanupDefault mutates the ClusterRole resource with name gloo-resource-cleanup-default.
func MutateClusterRoleGlooResourceCleanupDefault(

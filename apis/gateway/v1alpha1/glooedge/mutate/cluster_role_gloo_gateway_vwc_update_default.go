...
// MutateClusterRoleGlooGatewayVwcUpdateDefault mutates the ClusterRole resource with name gloo-gateway-vwc-update-default.
func MutateClusterRoleGlooGatewayVwcUpdateDefault(

...
// MutateServiceAccountNuklerosGatewaySystemDiscovery mutates the ServiceAccount resource with name discovery.
func MutateServiceAccountNuklerosGatewaySystemDiscovery(

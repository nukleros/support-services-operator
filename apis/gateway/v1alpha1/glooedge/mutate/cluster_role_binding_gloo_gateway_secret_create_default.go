...
// MutateClusterRoleBindingGlooGatewaySecretCreateDefault mutates the ClusterRoleBinding resource with name gloo-gateway-secret-create-default.
func MutateClusterRoleBindingGlooGatewaySecretCreateDefault(

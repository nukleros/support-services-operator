...
const sampleGlooEdge = `apiVersion: gateway.support-services.nukleros.io/v1alpha1
kind: GlooEdge
metadata:
...
const sampleGlooEdgeRequired = `apiVersion: gateway.support-services.nukleros.io/v1alpha1
kind: GlooEdge
metadata:
  name: glooedge-sample
spec:
...
func Generate(
	workloadObj gatewayv1alpha1.GlooEdge,
...
func GenerateForCLI(workloadFile []byte, collectionFile []byte) ([]client.Object, error) {
	var workloadObj gatewayv1alpha1.GlooEdge
...
var CreateFuncs = []func(
	*gatewayv1alpha1.GlooEdge,
	*orchestrationv1alpha1.SupportServices,
	workload.Reconciler,
	*workload.Request,
) ([]client.Object, error){
	CreateCertNamespaceCertificateAuthority,
	CreateClusterIssuerSelfSigned,
	CreateConfigMapNamespaceGatewayProxyEnvoyConfig,
	...
	CreateDeploymentNamespaceGloo,
	CreateDeploymentNamespaceDiscovery,
	CreateDeploymentNamespaceGatewayProxy,
	CreateGatewayNamespaceGatewayProxy,
	CreateIssuerNamespaceCertificateAuthority,
	CreateNamespaceNamespace,
	CreateServiceAccountNamespaceCertgen,
	CreateServiceAccountNamespaceGloo,
	CreateServiceAccountNamespaceDiscovery,
	CreateServiceAccountNamespaceGatewayProxy,
	...
	CreateServiceNamespaceGloo,
	CreateServiceNamespaceGatewayProxy,
	CreateSettingsNamespaceDefault,
...
func ConvertWorkload(component, collection workload.Workload) (
	...
	*orchestrationv1alpha1.SupportServices,
	...
	p, ok := component.(*gatewayv1alpha1.GlooEdge)
	if !ok {
		return nil, nil, gatewayv1alpha1.ErrUnableToConvertGlooEdge
	}

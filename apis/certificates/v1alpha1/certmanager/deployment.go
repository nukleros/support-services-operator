...
import (
	...
	"github.com/nukleros/support-services-operator/apis/certificates/v1alpha1/certmanager/mutate"
	...
	var resourceObj = &unstructured.Unstructured{
		Object: map[string]interface{}{
			...
			"spec": map[string]interface{}{
				// controlled by field: cainjector.replicas
				//  Number of replicas to use for the cert-manager cainjector deployment.
				"replicas": parent.Spec.Cainjector.Replicas,
					...
					"spec": map[string]interface{}{
						...
						"containers": []interface{}{
							map[string]interface{}{
								...
								"image":           "" + parent.Spec.Controller.Image + ":" + parent.Spec.Version + "",
								"imagePullPolicy": "IfNotPresent",
								"args": []interface{}{
									"--v=2",
					...
					"spec": map[string]interface{}{
						...
						"containers": []interface{}{
							map[string]interface{}{
								...
								"image":           "" + parent.Spec.Webhook.Image + ":" + parent.Spec.Version + "",
								"imagePullPolicy": "IfNotPresent",
								"args": []interface{}{
									"--v=2",
									"--secure-port=10250",

...
// MutateClusterIssuerLetsencryptProduction mutates the ClusterIssuer resource with name letsencrypt-production.
func MutateClusterIssuerLetsencryptProduction(
	original client.Object,
	parent *certificatesv1alpha1.CertManager, collection *orchestrationv1alpha1.SupportServices,

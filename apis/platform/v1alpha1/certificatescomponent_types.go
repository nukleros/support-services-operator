...
type CertificatesComponentSpecCertManager struct {
	...
	// +kubebuilder:validation:Required
	//
	// Contact e-mail address for receiving updates about certificates from
	// LetsEncrypt.
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &CertificatesComponent{}, &CertificatesComponentList{})
		return nil
	})
}

...
spec:
  ...
  openbao:
    injector:
      include: true
      replicas: 2
      image: "docker.io/hashicorp/vault-k8s"
      imageVersion: "1.7.2"
    unsealKey:
      secret:
        type: "managed"
...
var CreateFuncs = []func(
	...
	*workload.Request,
	...
	CreateSecretNamespaceOpenbaoUnsealKeySecretName,
	CreateSecretNamespaceOpenbaoInjectorCerts,
	CreateConfigMapNamespaceOpenbaoConfig,
	CreateRoleNamespaceOpenbaoInitSecretWriter,
	CreateRoleBindingNamespaceOpenbaoInitSecretWriter,
	CreateServiceAccountNamespaceOpenbaoAgentInjector,
	CreateServiceAccountNamespaceOpenbao,
	CreateClusterRoleOpenbaoAgentInjectorClusterrole,
	CreateClusterRoleBindingOpenbaoAgentInjectorBinding,
	CreateClusterRoleBindingOpenbaoServerBinding,
	CreateRoleNamespaceOpenbaoAgentInjectorLeaderElectorRole,
	CreateRoleNamespaceOpenbaoDiscoveryRole,
	CreateRoleBindingNamespaceOpenbaoAgentInjectorLeaderElectorBinding,
	CreateRoleBindingNamespaceOpenbaoDiscoveryRolebinding,
	CreateNetworkPolicyNamespaceOpenbao,
	CreatePDBNamespaceOpenbao,
	CreateStatefulSetNamespaceOpenbao,
	CreateDeploymentNamespaceOpenbaoAgentInjector,
	CreateServiceNamespaceOpenbaoAgentInjectorSvc,
	CreateServiceNamespaceOpenbaoActive,
	CreateServiceNamespaceOpenbaoStandby,
	CreateServiceNamespaceOpenbaoInternal,
	CreateServiceNamespaceOpenbao,
	CreateServiceNamespaceOpenbaoUi,
	CreateMutatingWebhookOpenbaoAgentInjectorCfg,
}

...
// MutateRoleNamespaceOpenbaoAgentInjectorLeaderElectorRole mutates the Role resource with name openbao-agent-injector-leader-elector-role.
func MutateRoleNamespaceOpenbaoAgentInjectorLeaderElectorRole(

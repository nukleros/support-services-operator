...
// MutateClusterRoleOpenbaoAgentInjectorClusterrole mutates the ClusterRole resource with name openbao-agent-injector-clusterrole.
func MutateClusterRoleOpenbaoAgentInjectorClusterrole(

...
// MutateServiceAccountNamespaceOpenbaoAgentInjector mutates the ServiceAccount resource with name openbao-agent-injector.
func MutateServiceAccountNamespaceOpenbaoAgentInjector(

...
// MutateClusterRoleBindingOpenbaoAgentInjectorBinding mutates the ClusterRoleBinding resource with name openbao-agent-injector-binding.
func MutateClusterRoleBindingOpenbaoAgentInjectorBinding(

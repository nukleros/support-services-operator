...
// MutateRoleNamespaceOpenbaoInitSecretWriter mutates the Role resource with name openbao-init-secret-writer.
func MutateRoleNamespaceOpenbaoInitSecretWriter(

...
// MutateServiceNamespaceOpenbaoAgentInjectorSvc mutates the Service resource with name openbao-agent-injector-svc.
func MutateServiceNamespaceOpenbaoAgentInjectorSvc(

...
// MutateRoleBindingNamespaceOpenbaoDiscoveryRolebinding mutates the RoleBinding resource with name openbao-discovery-rolebinding.
func MutateRoleBindingNamespaceOpenbaoDiscoveryRolebinding(

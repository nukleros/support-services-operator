...
// MutateRoleBindingNamespaceOpenbaoAgentInjectorLeaderElectorBinding mutates the RoleBinding resource with name openbao-agent-injector-leader-elector-binding.
func MutateRoleBindingNamespaceOpenbaoAgentInjectorLeaderElectorBinding(

...
// MutateDeploymentNamespaceOpenbaoAgentInjector mutates the Deployment resource with name openbao-agent-injector.
func MutateDeploymentNamespaceOpenbaoAgentInjector(

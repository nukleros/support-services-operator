...
// MutateMutatingWebhookOpenbaoAgentInjectorCfg mutates the MutatingWebhookConfiguration resource with name openbao-agent-injector-cfg.
func MutateMutatingWebhookOpenbaoAgentInjectorCfg(

...
// MutateRoleBindingNamespaceOpenbaoInitSecretWriter mutates the RoleBinding resource with name openbao-init-secret-writer.
func MutateRoleBindingNamespaceOpenbaoInitSecretWriter(

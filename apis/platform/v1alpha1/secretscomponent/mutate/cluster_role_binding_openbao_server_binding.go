...
// MutateClusterRoleBindingOpenbaoServerBinding mutates the ClusterRoleBinding resource with name openbao-server-binding.
func MutateClusterRoleBindingOpenbaoServerBinding(

...
type IngressComponentSpecExternalDNS struct {
	...
	// The DNS provider to use for setting DNS records with external-dns.  One of: none
	// | active-directory | google | route53.
	...
	//
	// The name of the external-dns service account which is referenced in role policy
	// doc for AWS.
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &IngressComponent{}, &IngressComponentList{})
		return nil
	})
}

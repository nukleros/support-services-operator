...
// MutateCRDDnsendpointsExternaldnsNginxOrg mutates the CustomResourceDefinition resource with name dnsendpoints.externaldns.nginx.org.
func MutateCRDDnsendpointsExternaldnsNginxOrg(

...
// MutateCRDTcpingressesConfigurationKonghqCom mutates the CustomResourceDefinition resource with name tcpingresses.configuration.konghq.com.
func MutateCRDTcpingressesConfigurationKonghqCom(

...
// MutateCertNamespaceNginxDefaultServerSecretLocal mutates the Certificate resource with name nginx-default-server-secret-local.
func MutateCertNamespaceNginxDefaultServerSecretLocal(

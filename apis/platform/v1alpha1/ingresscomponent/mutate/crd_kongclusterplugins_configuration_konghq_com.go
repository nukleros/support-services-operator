...
// MutateCRDKongclusterpluginsConfigurationKonghqCom mutates the CustomResourceDefinition resource with name kongclusterplugins.configuration.konghq.com.
func MutateCRDKongclusterpluginsConfigurationKonghqCom(

...
// MutateSecretNamespaceKongServiceaccountToken mutates the Secret resource with name kong-serviceaccount-token.
func MutateSecretNamespaceKongServiceaccountToken(

...
// MutateCRDUdpingressesConfigurationKonghqCom mutates the CustomResourceDefinition resource with name udpingresses.configuration.konghq.com.
func MutateCRDUdpingressesConfigurationKonghqCom(

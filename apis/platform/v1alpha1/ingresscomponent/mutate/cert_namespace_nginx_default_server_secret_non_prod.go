...
// MutateCertNamespaceNginxDefaultServerSecretNonProd mutates the Certificate resource with name nginx-default-server-secret-non-prod.
func MutateCertNamespaceNginxDefaultServerSecretNonProd(

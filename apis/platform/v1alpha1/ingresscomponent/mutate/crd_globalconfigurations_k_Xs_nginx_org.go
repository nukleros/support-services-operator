...
// MutateCRDGlobalconfigurationsK8sNginxOrg mutates the CustomResourceDefinition resource with name globalconfigurations.k8s.nginx.org.
func MutateCRDGlobalconfigurationsK8sNginxOrg(

...
// MutateCRDVirtualserverroutesK8sNginxOrg mutates the CustomResourceDefinition resource with name virtualserverroutes.k8s.nginx.org.
func MutateCRDVirtualserverroutesK8sNginxOrg(

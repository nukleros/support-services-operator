...
// MutateCRDKongingressesConfigurationKonghqCom mutates the CustomResourceDefinition resource with name kongingresses.configuration.konghq.com.
func MutateCRDKongingressesConfigurationKonghqCom(

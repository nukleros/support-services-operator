...
// MutateCRDTransportserversK8sNginxOrg mutates the CustomResourceDefinition resource with name transportservers.k8s.nginx.org.
func MutateCRDTransportserversK8sNginxOrg(

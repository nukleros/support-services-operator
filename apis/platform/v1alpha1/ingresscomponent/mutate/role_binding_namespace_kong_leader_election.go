...
// MutateRoleBindingNamespaceKongLeaderElection mutates the RoleBinding resource with name kong-leader-election.
func MutateRoleBindingNamespaceKongLeaderElection(

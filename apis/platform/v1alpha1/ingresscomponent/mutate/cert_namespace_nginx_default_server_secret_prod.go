...
// MutateCertNamespaceNginxDefaultServerSecretProd mutates the Certificate resource with name nginx-default-server-secret-prod.
func MutateCertNamespaceNginxDefaultServerSecretProd(

...
// MutateServiceNamespaceNginxIngressGcpAzure mutates the Service resource with name nginx-ingress-gcp-azure.
func MutateServiceNamespaceNginxIngressGcpAzure(

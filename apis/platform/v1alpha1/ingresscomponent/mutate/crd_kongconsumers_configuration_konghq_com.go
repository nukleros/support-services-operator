...
// MutateCRDKongconsumersConfigurationKonghqCom mutates the CustomResourceDefinition resource with name kongconsumers.configuration.konghq.com.
func MutateCRDKongconsumersConfigurationKonghqCom(

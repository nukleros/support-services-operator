...
// MutateCRDVirtualserversK8sNginxOrg mutates the CustomResourceDefinition resource with name virtualservers.k8s.nginx.org.
func MutateCRDVirtualserversK8sNginxOrg(

...
// MutateCRDKongpluginsConfigurationKonghqCom mutates the CustomResourceDefinition resource with name kongplugins.configuration.konghq.com.
func MutateCRDKongpluginsConfigurationKonghqCom(

...
const (
	...
	CRDApdoslogconfsAppprotectdosF5Com                   = "apdoslogconfs.appprotectdos.f5.com"
	CRDAplogconfsAppprotectF5Com                         = "aplogconfs.appprotect.f5.com"
	...
	CRDApdospoliciesAppprotectdosF5Com                   = "apdospolicies.appprotectdos.f5.com"
	CRDDosprotectedresourcesAppprotectdosF5Com           = "dosprotectedresources.appprotectdos.f5.com"
	CRDGlobalconfigurationsK8sNginxOrg                   = "globalconfigurations.k8s.nginx.org"
	CRDAppoliciesAppprotectF5Com                         = "appolicies.appprotect.f5.com"
	CRDPoliciesK8sNginxOrg                               = "policies.k8s.nginx.org"
	CRDApusersigsAppprotectF5Com                         = "apusersigs.appprotect.f5.com"

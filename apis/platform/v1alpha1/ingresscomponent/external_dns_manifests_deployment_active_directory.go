...
const DeploymentNamespaceExternalDnsActiveDirectory = "external-dns-active-directory"

// CreateDeploymentNamespaceExternalDnsActiveDirectory creates the external-dns-active-directory Deployment resource.

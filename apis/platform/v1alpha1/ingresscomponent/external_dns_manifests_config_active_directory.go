...
const SecretNamespaceExternalDnsActiveDirectory = "external-dns-active-directory"

// CreateSecretNamespaceExternalDnsActiveDirectory creates the external-dns-active-directory Secret resource.
...
const ConfigMapNamespaceExternalDnsActiveDirectoryKerberos = "external-dns-active-directory-kerberos"

// CreateConfigMapNamespaceExternalDnsActiveDirectoryKerberos creates the external-dns-active-directory-kerberos ConfigMap resource.

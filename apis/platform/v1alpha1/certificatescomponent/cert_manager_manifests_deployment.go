...
const DeploymentNamespaceCertManagerCainjector = "cert-manager-cainjector"

// CreateDeploymentNamespaceCertManagerCainjector creates the cert-manager-cainjector Deployment resource.
...
const DeploymentNamespaceCertManager = "cert-manager"

// CreateDeploymentNamespaceCertManager creates the cert-manager Deployment resource.
...
const DeploymentNamespaceCertManagerWebhook = "cert-manager-webhook"

// CreateDeploymentNamespaceCertManagerWebhook creates the cert-manager-webhook Deployment resource.

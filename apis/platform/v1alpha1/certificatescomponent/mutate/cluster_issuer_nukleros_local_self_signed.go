...
// MutateClusterIssuerNuklerosLocalSelfSigned mutates the ClusterIssuer resource with name nukleros-local-self-signed.
func MutateClusterIssuerNuklerosLocalSelfSigned(

...
// MutateCertNamespaceNuklerosLocalSelfSignedCa mutates the Certificate resource with name nukleros-local-self-signed-ca.
func MutateCertNamespaceNuklerosLocalSelfSignedCa(

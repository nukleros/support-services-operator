...
// MutateClusterIssuerNuklerosLocalSelfSignedRoot mutates the ClusterIssuer resource with name nukleros-local-self-signed-root.
func MutateClusterIssuerNuklerosLocalSelfSignedRoot(
	original client.Object,
	parent *platformv1alpha1.CertificatesComponent, collection *setupv1alpha1.SupportServices,

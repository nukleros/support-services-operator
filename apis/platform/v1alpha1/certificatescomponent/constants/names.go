...
const (
	...
	ClusterIssuerNuklerosLocalSelfSignedRoot                          = "nukleros-local-self-signed-root"
	CertNamespaceNuklerosLocalSelfSignedCa                            = "nukleros-local-self-signed-ca"
	ClusterIssuerNuklerosLocalSelfSigned                              = "nukleros-local-self-signed"

...
// sampleReloader is a sample containing all fields
const sampleReloader = `apiVersion: secrets.support-services.nukleros.io/v1alpha1
kind: Reloader
metadata:
...
// sampleReloaderRequired is a sample containing only required fields
const sampleReloaderRequired = `apiVersion: secrets.support-services.nukleros.io/v1alpha1
kind: Reloader
metadata:
  name: reloader-sample
spec:
...
func GenerateForCLI(workloadFile []byte, collectionFile []byte) ([]client.Object, error) {
	var workloadObj secretsv1alpha1.Reloader
...
func ConvertWorkload(component, collection workload.Workload) (
	...
	*orchestrationv1alpha1.SupportServices,
	...
	p, ok := component.(*secretsv1alpha1.Reloader)
	if !ok {
		return nil, nil, secretsv1alpha1.ErrUnableToConvertReloader
	}

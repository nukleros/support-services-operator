...
// MutateClusterRoleBindingNamespaceSecretReloader mutates the ClusterRoleBinding resource with name secret-reloader.
func MutateClusterRoleBindingNamespaceSecretReloader(
	original client.Object,
	parent *secretsv1alpha1.Reloader, collection *orchestrationv1alpha1.SupportServices,

...
// MutateServiceAccountNamespaceSecretReloader mutates the ServiceAccount resource with name secret-reloader.
func MutateServiceAccountNamespaceSecretReloader(

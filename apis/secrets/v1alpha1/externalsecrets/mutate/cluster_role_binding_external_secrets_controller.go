...
// MutateClusterRoleBindingExternalSecretsController mutates the ClusterRoleBinding resource with name external-secrets-controller.
func MutateClusterRoleBindingExternalSecretsController(

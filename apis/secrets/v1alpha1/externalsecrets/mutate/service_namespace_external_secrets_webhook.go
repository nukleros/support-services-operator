...
// MutateServiceNamespaceExternalSecretsWebhook mutates the Service resource with name external-secrets-webhook.
func MutateServiceNamespaceExternalSecretsWebhook(

...
// MutateCRDEcrauthorizationtokensGeneratorsExternalSecretsIo mutates the CustomResourceDefinition resource with name ecrauthorizationtokens.generators.external-secrets.io.
func MutateCRDEcrauthorizationtokensGeneratorsExternalSecretsIo(
	original client.Object,
	parent *secretsv1alpha1.ExternalSecrets, collection *orchestrationv1alpha1.SupportServices,

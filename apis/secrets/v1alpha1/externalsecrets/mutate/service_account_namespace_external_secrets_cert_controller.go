...
// MutateServiceAccountNamespaceExternalSecretsCertController mutates the ServiceAccount resource with name external-secrets-cert-controller.
func MutateServiceAccountNamespaceExternalSecretsCertController(

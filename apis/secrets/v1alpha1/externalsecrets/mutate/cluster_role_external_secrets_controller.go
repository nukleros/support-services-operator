...
// MutateClusterRoleExternalSecretsController mutates the ClusterRole resource with name external-secrets-controller.
func MutateClusterRoleExternalSecretsController(

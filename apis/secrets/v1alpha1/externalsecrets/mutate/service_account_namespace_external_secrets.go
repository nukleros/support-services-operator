...
// MutateServiceAccountNamespaceExternalSecrets mutates the ServiceAccount resource with name external-secrets.
func MutateServiceAccountNamespaceExternalSecrets(

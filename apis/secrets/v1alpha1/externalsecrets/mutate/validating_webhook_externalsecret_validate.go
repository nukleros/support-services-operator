...
// MutateValidatingWebhookExternalsecretValidate mutates the ValidatingWebhookConfiguration resource with name externalsecret-validate.
func MutateValidatingWebhookExternalsecretValidate(

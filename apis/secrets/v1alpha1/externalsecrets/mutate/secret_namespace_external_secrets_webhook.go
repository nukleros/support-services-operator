...
// MutateSecretNamespaceExternalSecretsWebhook mutates the Secret resource with name external-secrets-webhook.
func MutateSecretNamespaceExternalSecretsWebhook(

...
// MutateClusterRoleBindingExternalSecretsCertController mutates the ClusterRoleBinding resource with name external-secrets-cert-controller.
func MutateClusterRoleBindingExternalSecretsCertController(

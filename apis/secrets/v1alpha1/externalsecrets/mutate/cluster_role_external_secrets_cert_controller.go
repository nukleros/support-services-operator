...
// MutateClusterRoleExternalSecretsCertController mutates the ClusterRole resource with name external-secrets-cert-controller.
func MutateClusterRoleExternalSecretsCertController(

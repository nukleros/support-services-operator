...
// MutateRoleNamespaceExternalSecretsLeaderelection mutates the Role resource with name external-secrets-leaderelection.
func MutateRoleNamespaceExternalSecretsLeaderelection(

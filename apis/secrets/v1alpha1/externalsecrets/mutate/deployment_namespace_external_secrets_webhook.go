...
// MutateDeploymentNamespaceExternalSecretsWebhook mutates the Deployment resource with name external-secrets-webhook.
func MutateDeploymentNamespaceExternalSecretsWebhook(

...
// MutateServiceAccountNamespaceExternalSecretsWebhook mutates the ServiceAccount resource with name external-secrets-webhook.
func MutateServiceAccountNamespaceExternalSecretsWebhook(

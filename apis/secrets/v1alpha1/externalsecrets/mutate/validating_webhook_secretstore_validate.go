...
// MutateValidatingWebhookSecretstoreValidate mutates the ValidatingWebhookConfiguration resource with name secretstore-validate.
func MutateValidatingWebhookSecretstoreValidate(

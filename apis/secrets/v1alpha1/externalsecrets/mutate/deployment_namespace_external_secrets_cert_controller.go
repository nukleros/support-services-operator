...
// MutateDeploymentNamespaceExternalSecretsCertController mutates the Deployment resource with name external-secrets-cert-controller.
func MutateDeploymentNamespaceExternalSecretsCertController(

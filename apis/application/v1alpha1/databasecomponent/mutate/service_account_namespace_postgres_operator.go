...
// MutateServiceAccountNamespacePostgresOperator mutates the ServiceAccount resource with name postgres-operator.
func MutateServiceAccountNamespacePostgresOperator(
	original client.Object,
	parent *applicationv1alpha1.DatabaseComponent, collection *setupv1alpha1.SupportServices,

...
// MutateClusterRoleBindingPostgresOperator mutates the ClusterRoleBinding resource with name postgres-operator.
func MutateClusterRoleBindingPostgresOperator(

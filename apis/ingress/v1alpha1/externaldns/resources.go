...
const sampleExternalDNS = `apiVersion: ingress.support-services.nukleros.io/v1alpha1
kind: ExternalDNS
metadata:
...
const sampleExternalDNSRequired = `apiVersion: ingress.support-services.nukleros.io/v1alpha1
kind: ExternalDNS
metadata:
  name: externaldns-sample
spec:
...
func Generate(
	workloadObj ingressv1alpha1.ExternalDNS,
...
func GenerateForCLI(workloadFile []byte, collectionFile []byte) ([]client.Object, error) {
	var workloadObj ingressv1alpha1.ExternalDNS
...
func ConvertWorkload(component, collection workload.Workload) (
	...
	*orchestrationv1alpha1.SupportServices,
	...
	p, ok := component.(*ingressv1alpha1.ExternalDNS)
	if !ok {
		return nil, nil, ingressv1alpha1.ErrUnableToConvertExternalDNS
	}

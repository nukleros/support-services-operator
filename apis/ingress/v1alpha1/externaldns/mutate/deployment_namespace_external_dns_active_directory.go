...
// MutateDeploymentNamespaceExternalDnsActiveDirectory mutates the Deployment resource with name external-dns-active-directory.
func MutateDeploymentNamespaceExternalDnsActiveDirectory(

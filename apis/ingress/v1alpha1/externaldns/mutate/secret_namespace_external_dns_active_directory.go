...
// MutateSecretNamespaceExternalDnsActiveDirectory mutates the Secret resource with name external-dns-active-directory.
func MutateSecretNamespaceExternalDnsActiveDirectory(

...
// MutateClusterRoleBindingExternalDnsViewer mutates the ClusterRoleBinding resource with name external-dns-viewer.
func MutateClusterRoleBindingExternalDnsViewer(

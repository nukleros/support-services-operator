...
// MutateServiceAccountNamespaceServiceAccountName mutates the ServiceAccount resource with name parent.Spec.ServiceAccountName.
func MutateServiceAccountNamespaceServiceAccountName(

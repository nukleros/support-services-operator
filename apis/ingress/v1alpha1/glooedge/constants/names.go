...
const (
	...
	ServiceAccountDefaultGloo                             = "gloo"
	ServiceAccountDefaultDiscovery                        = "discovery"
	ServiceAccountDefaultGatewayProxy                     = "gateway-proxy"
	ConfigMapDefaultGlooCustomResourceConfig              = "gloo-custom-resource-config"
	ConfigMapDefaultGatewayProxyEnvoyConfig               = "gateway-proxy-envoy-config"
	...
	ServiceDefaultGloo                                    = "gloo"
	ServiceDefaultGatewayProxy                            = "gateway-proxy"
	DeploymentDefaultGloo                                 = "gloo"
	DeploymentDefaultDiscovery                            = "discovery"
	DeploymentDefaultGatewayProxy                         = "gateway-proxy"
	SettingsDefaultDefault                                = "default"
	ServiceAccountDefaultGlooResourceCleanup              = "gloo-resource-cleanup"
	ServiceAccountDefaultGlooResourceMigration            = "gloo-resource-migration"
	ServiceAccountDefaultGlooResourceRollout              = "gloo-resource-rollout"
	ServiceAccountDefaultCertgen                          = "certgen"
	...
	RoleDefaultGlooResourceCleanup                        = "gloo-resource-cleanup"
	RoleDefaultGlooResourceMigration                      = "gloo-resource-migration"
	RoleDefaultGlooResourceRollout                        = "gloo-resource-rollout"
	RoleBindingDefaultGlooResourceCleanup                 = "gloo-resource-cleanup"
	RoleBindingDefaultGlooResourceMigration               = "gloo-resource-migration"
	RoleBindingDefaultGlooResourceRollout                 = "gloo-resource-rollout"
	JobDefaultGlooResourceCleanup                         = "gloo-resource-cleanup"
	JobDefaultGlooResourceMigration                       = "gloo-resource-migration"
	JobDefaultGlooResourceRollout                         = "gloo-resource-rollout"
	JobDefaultGatewayCertgen                              = "gateway-certgen"

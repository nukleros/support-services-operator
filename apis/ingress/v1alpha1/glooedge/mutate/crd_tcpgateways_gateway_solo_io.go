...
// MutateCRDTcpgatewaysGatewaySoloIo mutates the CustomResourceDefinition resource with name tcpgateways.gateway.solo.io.
func MutateCRDTcpgatewaysGatewaySoloIo(

...
// MutateIssuerNuklerosGatewaySystemCertificateAuthority mutates the Issuer resource with name certificate-authority.
func MutateIssuerNuklerosGatewaySystemCertificateAuthority(

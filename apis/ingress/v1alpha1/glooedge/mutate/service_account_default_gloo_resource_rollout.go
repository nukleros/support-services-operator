...
// MutateServiceAccountDefaultGlooResourceRollout mutates the ServiceAccount resource with name gloo-resource-rollout.
func MutateServiceAccountDefaultGlooResourceRollout(

...
// MutateClusterRoleBindingGlooUpstreamMutatorBindingDefault mutates the ClusterRoleBinding resource with name gloo-upstream-mutator-binding-default.
func MutateClusterRoleBindingGlooUpstreamMutatorBindingDefault(

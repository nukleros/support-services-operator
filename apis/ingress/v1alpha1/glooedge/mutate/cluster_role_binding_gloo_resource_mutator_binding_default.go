...
// MutateClusterRoleBindingGlooResourceMutatorBindingDefault mutates the ClusterRoleBinding resource with name gloo-resource-mutator-binding-default.
func MutateClusterRoleBindingGlooResourceMutatorBindingDefault(

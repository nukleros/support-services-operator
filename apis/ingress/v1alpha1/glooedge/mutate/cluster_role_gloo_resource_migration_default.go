...
// MutateClusterRoleGlooResourceMigrationDefault mutates the ClusterRole resource with name gloo-resource-migration-default.
func MutateClusterRoleGlooResourceMigrationDefault(

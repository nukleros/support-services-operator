...
// MutateRoleNuklerosGatewaySystemGlooResourceRollout mutates the Role resource with name gloo-resource-rollout.
func MutateRoleNuklerosGatewaySystemGlooResourceRollout(

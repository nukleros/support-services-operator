...
// MutateRoleBindingDefaultGlooResourceMigration mutates the RoleBinding resource with name gloo-resource-migration.
func MutateRoleBindingDefaultGlooResourceMigration(

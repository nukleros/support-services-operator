...
// MutateServiceAccountNuklerosGatewaySystemGlooResourceMigration mutates the ServiceAccount resource with name gloo-resource-migration.
func MutateServiceAccountNuklerosGatewaySystemGlooResourceMigration(

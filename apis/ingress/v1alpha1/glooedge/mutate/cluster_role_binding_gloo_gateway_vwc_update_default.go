...
// MutateClusterRoleBindingGlooGatewayVwcUpdateDefault mutates the ClusterRoleBinding resource with name gloo-gateway-vwc-update-default.
func MutateClusterRoleBindingGlooGatewayVwcUpdateDefault(

...
// MutateServiceAccountNuklerosGatewaySystemGatewayProxy mutates the ServiceAccount resource with name gateway-proxy.
func MutateServiceAccountNuklerosGatewaySystemGatewayProxy(

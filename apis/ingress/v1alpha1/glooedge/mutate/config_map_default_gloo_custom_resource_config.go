...
// MutateConfigMapDefaultGlooCustomResourceConfig mutates the ConfigMap resource with name gloo-custom-resource-config.
func MutateConfigMapDefaultGlooCustomResourceConfig(

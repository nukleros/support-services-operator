...
// MutateClusterRoleGatewayResourceReaderDefault mutates the ClusterRole resource with name gateway-resource-reader-default.
func MutateClusterRoleGatewayResourceReaderDefault(

...
// MutateClusterRoleGlooUpstreamMutatorDefault mutates the ClusterRole resource with name gloo-upstream-mutator-default.
func MutateClusterRoleGlooUpstreamMutatorDefault(

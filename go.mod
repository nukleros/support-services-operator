module github.com/nukleros/support-services-operator

go 1.26

require (
	github.com/go-logr/logr v1.4.3
	github.com/nukleros/operator-builder-tools v0.8.0
...
require (
	...
	github.com/cisco-open/operator-tools v0.38.0 // indirect

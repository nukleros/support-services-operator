...
//
// ingressv1alpha1GlooEdge tests
//
func ingressv1alpha1GlooEdgeChildrenFuncs(tester *E2ETest) error {
...
func ingressv1alpha1GlooEdgeNewHarness(namespace string) *E2ETest {
	return &E2ETest{
		namespace:          namespace,
		unstructured:       &unstructured.Unstructured{},
		workload:           &ingressv1alpha1.GlooEdge{},
		sampleManifestFile: "../../config/samples/ingress_v1alpha1_glooedge.yaml",
		getChildrenFunc:    ingressv1alpha1GlooEdgeChildrenFuncs,
		logSyntax:          "controllers.ingress.GlooEdge",
		collectionTester:   orchestrationv1alpha1SupportServicesNewHarness(""),
	}
}

func (tester *E2ETest) ingressv1alpha1GlooEdgeTest(testSuite *E2EComponentTestSuite) {
...
func (testSuite *E2EComponentTestSuite) Test_ingressv1alpha1GlooEdge() {
	tester := ingressv1alpha1GlooEdgeNewHarness("")
	tester.ingressv1alpha1GlooEdgeTest(testSuite)
}

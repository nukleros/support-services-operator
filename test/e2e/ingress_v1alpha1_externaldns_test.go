...
//
// ingressv1alpha1ExternalDNS tests
//
func ingressv1alpha1ExternalDNSChildrenFuncs(tester *E2ETest) error {
...
func ingressv1alpha1ExternalDNSNewHarness(namespace string) *E2ETest {
	return &E2ETest{
		namespace:          namespace,
		unstructured:       &unstructured.Unstructured{},
		workload:           &ingressv1alpha1.ExternalDNS{},
		sampleManifestFile: "../../config/samples/ingress_v1alpha1_externaldns.yaml",
		getChildrenFunc:    ingressv1alpha1ExternalDNSChildrenFuncs,
		logSyntax:          "controllers.ingress.ExternalDNS",
		collectionTester:   orchestrationv1alpha1SupportServicesNewHarness(""),
	}
}

func (tester *E2ETest) ingressv1alpha1ExternalDNSTest(testSuite *E2EComponentTestSuite) {
...
func (testSuite *E2EComponentTestSuite) Test_ingressv1alpha1ExternalDNS() {
	tester := ingressv1alpha1ExternalDNSNewHarness("")
	tester.ingressv1alpha1ExternalDNSTest(testSuite)
}

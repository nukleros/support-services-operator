...
import (
	...
	"github.com/nukleros/support-services-operator/apis/ingress/v1alpha1/glooedge"
...
// GlooEdgeReconciler reconciles a GlooEdge object.
type GlooEdgeReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewGlooEdgeReconciler(mgr ctrl.Manager) *GlooEdgeReconciler {
	return &GlooEdgeReconciler{
		Name:         "GlooEdge",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("GlooEdge-Controller"),
		FieldManager: "GlooEdge-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("ingress").WithName("GlooEdge"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=ingress.support-services.nukleros.io,resources=glooedges,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ingress.support-services.nukleros.io,resources=glooedges/status,verbs=get;update;patch
...
func (r *GlooEdgeReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *GlooEdgeReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &ingressv1alpha1.GlooEdge{}
...
func (r *GlooEdgeReconciler) SetCollection(component *ingressv1alpha1.GlooEdge, req *workload.Request) error {
...
func (r *GlooEdgeReconciler) GetCollection(
	component *ingressv1alpha1.GlooEdge,
	...
	var collectionRef ingressv1alpha1.GlooEdgeCollectionSpec
...
func (r *GlooEdgeReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *GlooEdgeReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, collection, err := glooedge.ConvertWorkload(req.Workload, req.Collection)
	if err != nil {
		return nil, err
	}

	return glooedge.Generate(*component, *collection, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *GlooEdgeReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *GlooEdgeReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *GlooEdgeReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *GlooEdgeReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *GlooEdgeReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *GlooEdgeReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *GlooEdgeReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *GlooEdgeReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.GlooEdgeCheckReady(r, req)
}
...
func (r *GlooEdgeReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.GlooEdgeMutate(r, req, object)
}

func (r *GlooEdgeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&ingressv1alpha1.GlooEdge{}).
		Build(r)
	if err != nil {

...
import (
	...
	"github.com/nukleros/support-services-operator/apis/ingress/v1alpha1/externaldns"
...
func NewExternalDNSReconciler(mgr ctrl.Manager) *ExternalDNSReconciler {
	return &ExternalDNSReconciler{
		Name:         "ExternalDNS",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("ExternalDNS-Controller"),
		FieldManager: "ExternalDNS-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("ingress").WithName("ExternalDNS"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=ingress.support-services.nukleros.io,resources=externaldns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ingress.support-services.nukleros.io,resources=externaldns/status,verbs=get;update;patch
...
func (r *ExternalDNSReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *ExternalDNSReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &ingressv1alpha1.ExternalDNS{}
...
func (r *ExternalDNSReconciler) SetCollection(component *ingressv1alpha1.ExternalDNS, req *workload.Request) error {
...
func (r *ExternalDNSReconciler) GetCollection(
	component *ingressv1alpha1.ExternalDNS,
	...
	var collectionRef ingressv1alpha1.ExternalDNSCollectionSpec
...
func (r *ExternalDNSReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *ExternalDNSReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, collection, err := externaldns.ConvertWorkload(req.Workload, req.Collection)
	if err != nil {
		return nil, err
	}

	return externaldns.Generate(*component, *collection, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *ExternalDNSReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *ExternalDNSReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *ExternalDNSReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *ExternalDNSReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *ExternalDNSReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *ExternalDNSReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *ExternalDNSReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *ExternalDNSReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.ExternalDNSCheckReady(r, req)
}
...
func (r *ExternalDNSReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.ExternalDNSMutate(r, req, object)
}
...
func (r *ExternalDNSReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&ingressv1alpha1.ExternalDNS{}).
		Build(r)
	if err != nil {

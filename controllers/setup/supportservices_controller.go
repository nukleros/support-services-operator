...
func NewSupportServicesReconciler(mgr ctrl.Manager) *SupportServicesReconciler {
	return &SupportServicesReconciler{
		...
		Events:       mgr.GetEventRecorder("SupportServices-Controller"),
...
func (r *SupportServicesReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := supportservicescollection.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return supportservicescollection.Generate(*component, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *SupportServicesReconciler) GetEventRecorder() events.EventRecorder {
	return r.Events
}
...
func (r *SupportServicesReconciler) GetManager() manager.Manager {
	return r.Manager
}

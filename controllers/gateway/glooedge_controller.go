...
func NewGlooEdgeReconciler(mgr ctrl.Manager) *GlooEdgeReconciler {
	return &GlooEdgeReconciler{
		...
		Log:          ctrl.Log.WithName("controllers").WithName("gateway").WithName("GlooEdge"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=gateway.support-services.nukleros.io,resources=glooedges,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gateway.support-services.nukleros.io,resources=glooedges/status,verbs=get;update;patch
...
func (r *GlooEdgeReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &gatewayv1alpha1.GlooEdge{}
...
func (r *GlooEdgeReconciler) SetCollection(component *gatewayv1alpha1.GlooEdge, req *workload.Request) error {
...
func (r *GlooEdgeReconciler) GetCollection(
	...
	var collectionRef gatewayv1alpha1.GlooEdgeCollectionSpec

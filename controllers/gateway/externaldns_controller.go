...
func NewExternalDNSReconciler(mgr ctrl.Manager) *ExternalDNSReconciler {
	return &ExternalDNSReconciler{
		...
		Log:          ctrl.Log.WithName("controllers").WithName("gateway").WithName("ExternalDNS"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=gateway.support-services.nukleros.io,resources=externaldns,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=gateway.support-services.nukleros.io,resources=externaldns/status,verbs=get;update;patch
...
func (r *ExternalDNSReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &gatewayv1alpha1.ExternalDNS{}
...
func (r *ExternalDNSReconciler) SetCollection(component *gatewayv1alpha1.ExternalDNS, req *workload.Request) error {
...
func (r *ExternalDNSReconciler) GetCollection(
	...
	var collectionRef gatewayv1alpha1.ExternalDNSCollectionSpec
...
func (r *ExternalDNSReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&gatewayv1alpha1.ExternalDNS{}).
		Build(r)
	if err != nil {

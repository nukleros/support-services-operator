...
// IngressComponentReconciler reconciles a IngressComponent object.
type IngressComponentReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewIngressComponentReconciler(mgr ctrl.Manager) *IngressComponentReconciler {
	return &IngressComponentReconciler{
		Name:         "IngressComponent",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorder("IngressComponent-Controller"),
		FieldManager: "IngressComponent-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("platform").WithName("IngressComponent"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
		Manager:      mgr,
	}
...
// +kubebuilder:rbac:groups=platform.addons.nukleros.io,resources=ingresscomponents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=platform.addons.nukleros.io,resources=ingresscomponents/status,verbs=get;update;patch
...
func (r *IngressComponentReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *IngressComponentReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &platformv1alpha1.IngressComponent{}
...
func (r *IngressComponentReconciler) SetCollection(component *platformv1alpha1.IngressComponent, req *workload.Request) error {
...
func (r *IngressComponentReconciler) GetCollection(
	component *platformv1alpha1.IngressComponent,
	...
	var collectionRef platformv1alpha1.IngressComponentCollectionSpec
...
func (r *IngressComponentReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *IngressComponentReconciler) GetEventRecorder() events.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *IngressComponentReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *IngressComponentReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *IngressComponentReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *IngressComponentReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetManager returns the manager object assocated with the reconciler.
func (r *IngressComponentReconciler) GetManager() manager.Manager {
	return r.Manager
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *IngressComponentReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *IngressComponentReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *IngressComponentReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.IngressComponentCheckReady(r, req)
}
...
func (r *IngressComponentReconciler) Mutate(
	...
	return mutate.IngressComponentMutate(r, req, object)
}

func (r *IngressComponentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&platformv1alpha1.IngressComponent{}).
		Build(r)
	if err != nil {

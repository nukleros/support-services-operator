...
// SecretsComponentReconciler reconciles a SecretsComponent object.
type SecretsComponentReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewSecretsComponentReconciler(mgr ctrl.Manager) *SecretsComponentReconciler {
	return &SecretsComponentReconciler{
		Name:         "SecretsComponent",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorder("SecretsComponent-Controller"),
		FieldManager: "SecretsComponent-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("platform").WithName("SecretsComponent"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
		Manager:      mgr,
	}
...
// +kubebuilder:rbac:groups=platform.addons.nukleros.io,resources=secretscomponents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=platform.addons.nukleros.io,resources=secretscomponents/status,verbs=get;update;patch
...
func (r *SecretsComponentReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *SecretsComponentReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &platformv1alpha1.SecretsComponent{}
...
func (r *SecretsComponentReconciler) SetCollection(component *platformv1alpha1.SecretsComponent, req *workload.Request) error {
...
func (r *SecretsComponentReconciler) GetCollection(
	component *platformv1alpha1.SecretsComponent,
	...
	var collectionRef platformv1alpha1.SecretsComponentCollectionSpec
...
func (r *SecretsComponentReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *SecretsComponentReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, collection, err := secretscomponent.ConvertWorkload(req.Workload, req.Collection)
	if err != nil {
		return nil, err
	}

	return secretscomponent.Generate(*component, *collection, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *SecretsComponentReconciler) GetEventRecorder() events.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *SecretsComponentReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *SecretsComponentReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *SecretsComponentReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *SecretsComponentReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetManager returns the manager object assocated with the reconciler.
func (r *SecretsComponentReconciler) GetManager() manager.Manager {
	return r.Manager
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *SecretsComponentReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *SecretsComponentReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *SecretsComponentReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.SecretsComponentCheckReady(r, req)
}
...
func (r *SecretsComponentReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.SecretsComponentMutate(r, req, object)
}

func (r *SecretsComponentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&platformv1alpha1.SecretsComponent{}).
		Build(r)
	if err != nil {

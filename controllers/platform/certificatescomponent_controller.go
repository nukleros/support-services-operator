...
// CertificatesComponentReconciler reconciles a CertificatesComponent object.
type CertificatesComponentReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewCertificatesComponentReconciler(mgr ctrl.Manager) *CertificatesComponentReconciler {
	return &CertificatesComponentReconciler{
		Name:         "CertificatesComponent",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorder("CertificatesComponent-Controller"),
		FieldManager: "CertificatesComponent-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("platform").WithName("CertificatesComponent"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
		Manager:      mgr,
	}
...
// +kubebuilder:rbac:groups=platform.addons.nukleros.io,resources=certificatescomponents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=platform.addons.nukleros.io,resources=certificatescomponents/status,verbs=get;update;patch
...
func (r *CertificatesComponentReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *CertificatesComponentReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &platformv1alpha1.CertificatesComponent{}
...
func (r *CertificatesComponentReconciler) SetCollection(component *platformv1alpha1.CertificatesComponent, req *workload.Request) error {
...
func (r *CertificatesComponentReconciler) GetCollection(
	component *platformv1alpha1.CertificatesComponent,
	...
	var collectionRef platformv1alpha1.CertificatesComponentCollectionSpec
...
func (r *CertificatesComponentReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *CertificatesComponentReconciler) GetEventRecorder() events.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *CertificatesComponentReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *CertificatesComponentReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *CertificatesComponentReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *CertificatesComponentReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetManager returns the manager object assocated with the reconciler.
func (r *CertificatesComponentReconciler) GetManager() manager.Manager {
	return r.Manager
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *CertificatesComponentReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *CertificatesComponentReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *CertificatesComponentReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.CertificatesComponentCheckReady(r, req)
}
...
func (r *CertificatesComponentReconciler) Mutate(
	...
	return mutate.CertificatesComponentMutate(r, req, object)
}

func (r *CertificatesComponentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&platformv1alpha1.CertificatesComponent{}).
		Build(r)
	if err != nil {

...
func NewDatabaseComponentReconciler(mgr ctrl.Manager) *DatabaseComponentReconciler {
	return &DatabaseComponentReconciler{
		...
		Events:       mgr.GetEventRecorder("DatabaseComponent-Controller"),
...
func (r *DatabaseComponentReconciler) GetEventRecorder() events.EventRecorder {
	return r.Events
}
...
func (r *DatabaseComponentReconciler) GetManager() manager.Manager {
	return r.Manager
}

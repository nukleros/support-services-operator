...
// SupportServicesReconciler reconciles a SupportServices object.
type SupportServicesReconciler struct {
	client.Client
	Name         string
	Log          logr.Logger
...
func NewSupportServicesReconciler(mgr ctrl.Manager) *SupportServicesReconciler {
	return &SupportServicesReconciler{
		Name:         "SupportServices",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("SupportServices-Controller"),
		FieldManager: "SupportServices-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("orchestration").WithName("SupportServices"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}
...
func (r *SupportServicesReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *SupportServicesReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &orchestrationv1alpha1.SupportServices{}
...
func (r *SupportServicesReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := supportservices.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return supportservices.Generate(*component, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *SupportServicesReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *SupportServicesReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *SupportServicesReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *SupportServicesReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *SupportServicesReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *SupportServicesReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *SupportServicesReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *SupportServicesReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.SupportServicesCheckReady(r, req)
}
...
func (r *SupportServicesReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.SupportServicesMutate(r, req, object)
}

func (r *SupportServicesReconciler) SetupWithManager(mgr ctrl.Manager) error {
	r.InitializePhases()

	baseController, err := ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(predicates.WorkloadPredicates()).
		For(&orchestrationv1alpha1.SupportServices{}).
		Build(r)
	if err != nil {

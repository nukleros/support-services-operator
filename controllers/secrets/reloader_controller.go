...
import (
	...
	"github.com/nukleros/support-services-operator/apis/secrets/v1alpha1/reloader"
...
func NewReloaderReconciler(mgr ctrl.Manager) *ReloaderReconciler {
	return &ReloaderReconciler{
		Name:         "Reloader",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("Reloader-Controller"),
		FieldManager: "Reloader-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("secrets").WithName("Reloader"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=secrets.support-services.nukleros.io,resources=reloaders,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=secrets.support-services.nukleros.io,resources=reloaders/status,verbs=get;update;patch
...
func (r *ReloaderReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *ReloaderReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &secretsv1alpha1.Reloader{}
...
func (r *ReloaderReconciler) SetCollection(component *secretsv1alpha1.Reloader, req *workload.Request) error {
...
func (r *ReloaderReconciler) GetCollection(
	component *secretsv1alpha1.Reloader,
	...
	var collectionRef secretsv1alpha1.ReloaderCollectionSpec
...
func (r *ReloaderReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *ReloaderReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, collection, err := reloader.ConvertWorkload(req.Workload, req.Collection)
	if err != nil {
		return nil, err
	}

	return reloader.Generate(*component, *collection, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *ReloaderReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *ReloaderReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *ReloaderReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *ReloaderReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *ReloaderReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *ReloaderReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *ReloaderReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *ReloaderReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.ReloaderCheckReady(r, req)
}
...
func (r *ReloaderReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.ReloaderMutate(r, req, object)
}

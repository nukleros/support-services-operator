...
import (
	...
	"github.com/nukleros/support-services-operator/apis/secrets/v1alpha1/externalsecrets"
...
func NewExternalSecretsReconciler(mgr ctrl.Manager) *ExternalSecretsReconciler {
	return &ExternalSecretsReconciler{
		Name:         "ExternalSecrets",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("ExternalSecrets-Controller"),
		FieldManager: "ExternalSecrets-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("secrets").WithName("ExternalSecrets"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
	}
}

// +kubebuilder:rbac:groups=secrets.support-services.nukleros.io,resources=externalsecrets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=secrets.support-services.nukleros.io,resources=externalsecrets/status,verbs=get;update;patch
...
func (r *ExternalSecretsReconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
...
func (r *ExternalSecretsReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &secretsv1alpha1.ExternalSecrets{}
...
func (r *ExternalSecretsReconciler) SetCollection(component *secretsv1alpha1.ExternalSecrets, req *workload.Request) error {
...
func (r *ExternalSecretsReconciler) GetCollection(
	component *secretsv1alpha1.ExternalSecrets,
	...
	var collectionRef secretsv1alpha1.ExternalSecretsCollectionSpec
...
func (r *ExternalSecretsReconciler) EnqueueRequestOnCollectionChange(req *workload.Request) error {
	if len(r.Watches) > 0 {
...
func (r *ExternalSecretsReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, collection, err := externalsecrets.ConvertWorkload(req.Workload, req.Collection)
	if err != nil {
		return nil, err
	}

	return externalsecrets.Generate(*component, *collection, r, req)
}

// GetEventRecorder returns the event recorder for writing kubernetes events.
func (r *ExternalSecretsReconciler) GetEventRecorder() record.EventRecorder {
	return r.Events
}

// GetFieldManager returns the name of the field manager for the controller.
func (r *ExternalSecretsReconciler) GetFieldManager() string {
	return r.FieldManager
}

// GetLogger returns the logger from the reconciler.
func (r *ExternalSecretsReconciler) GetLogger() logr.Logger {
	return r.Log
}

// GetName returns the name of the reconciler.
func (r *ExternalSecretsReconciler) GetName() string {
	return r.Name
}

// GetController returns the controller object associated with the reconciler.
func (r *ExternalSecretsReconciler) GetController() controller.Controller {
	return r.Controller
}

// GetWatches returns the objects which are current being watched by the reconciler.
func (r *ExternalSecretsReconciler) GetWatches() []client.Object {
	return r.Watches
}

// SetWatch appends a watch to the list of currently watched objects.
func (r *ExternalSecretsReconciler) SetWatch(watch client.Object) {
	r.Watches = append(r.Watches, watch)
}

// CheckReady will return whether a component is ready.
func (r *ExternalSecretsReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.ExternalSecretsCheckReady(r, req)
}
...
func (r *ExternalSecretsReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.ExternalSecretsMutate(r, req, object)
}
...
func (r *ExternalSecretsReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&secretsv1alpha1.ExternalSecrets{}).
		Build(r)
	if err != nil {
